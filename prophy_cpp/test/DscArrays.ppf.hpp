#ifndef _PROPHY_GENERATED_FULL_DscArrays_HPP
#define _PROPHY_GENERATED_FULL_DscArrays_HPP
...
struct Builtin : public prophy::detail::message_dsc<Builtin>
{
    ...
    Builtin(): x(), y() { }
    Builtin(uint8_t _1, uint16_t _2): x(_1), y(_2) { }
...
#endif  /* _PROPHY_GENERATED_FULL_DscArrays_HPP */
