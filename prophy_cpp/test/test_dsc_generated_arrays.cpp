...
using namespace prophy::generated::dsc;

TEST(dsc_generated_arrays, Builtin)
{
...
//TEST(dsc_generated_arrays, BuiltinFixed)
//{
//    std::vector<uint8_t> data(1024);
//
...
//}
//
//TEST(dsc_generated_arrays, BuiltinDynamic)
//{
//    std::vector<uint8_t> data(1024);
//
...
//}
//
//TEST(dsc_generated_arrays, BuiltinLimited)
//{
//    std::vector<uint8_t> data(1024);
//
//    BuiltinLimited x{{1}};
...
//}
//
//TEST(dsc_generated_arrays, BuiltinGreedy)
//{
//    std::vector<uint8_t> data(1024);
//
//    BuiltinGreedy x{{1, 2}};
...
//}
//
//TEST(dsc_generated_arrays, Fixcomp)
//{
//    std::vector<uint8_t> data(1024);
//
//    Fixcomp x{{1, 2}, {3, 4}};
...
//}
//
//TEST(dsc_generated_arrays, FixcompFixed)
//{
//    std::vector<uint8_t> data(1024);
//
...
//}
//
//TEST(dsc_generated_arrays, FixcompDynamic)
//{
//    std::vector<uint8_t> data(1024);
//
...
//}
//
//TEST(dsc_generated_arrays, FixcompLimited)
//{
//    std::vector<uint8_t> data(1024);
//
...
//}
//
//TEST(dsc_generated_arrays, FixcompGreedy)
//{
//    std::vector<uint8_t> data(1024);
//
...
//}
//
//TEST(dsc_generated_arrays, Dyncomp)
//{
//    std::vector<uint8_t> data(1024);
//
//    Dyncomp x{{{1, 2, 3}}};
...
//}
//
//TEST(dsc_generated_arrays, DyncompDynamic)
//{
//    std::vector<uint8_t> data(1024);
//
...
//}
//
//TEST(dsc_generated_arrays, DyncompGreedy)
//{
//    std::vector<uint8_t> data(1024);
//
