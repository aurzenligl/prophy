 def receive_message(self, p_connection, p_messageToExpect, p_silentOperation = False, p_noTimeoutException = False, p_wrongOrderIsFatal = False):
        """
        ...
        # Copy the original message as the received data can append the 'unknown' fields to the structure
