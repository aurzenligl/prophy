...
""")
    ...
    errlines = err.splitlines()
    assert len(errlines) == 2
    v1 = 'input.cpp:1:20: warning: control reaches end of non-void function'
    v2 = 'non-void function does not return a value'
    assert v1 in errlines[0] or v2 in errlines[0]
