...
def test_prophy_structs_equality():
    check_eq(OneStruct, SameStruct, DifferentStruct, OneEnum, OneUnion, float, object)
    check_eq(OneEnum, SameEnum, DifferentEnum, OneStruct, OneUnion, float, object)
    check_eq(OneUnion, SameUnion, DifferentUnion, OneStruct, OneEnum, float, object)
